    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-text-secondary/60 text-xs mt-1">
          Start logging your meals on the Today page!
        </p>
      </div>
    );
  }
        ...
        {orderedLogs.map((log, index) => {
          ...
          return (
            ...
            >
              ...
              {!isLast && (
                <div className="flex items-center gap-2 sm:gap-4 py-1 sm:py-1.5 mb-2 sm:mb-4">
                  <div className="w-9 sm:w-12 text-right shrink-0">
                    <span className="text-[9px] sm:text-[10px] text-green-300 tabular-nums">
                      +{formatMinutes(gapToNextMinutes)}
                    </span>
                  </div>
                  <div className="w-2.5 sm:w-3 shrink-0" />
        ...
        >
          ...
          {logs.length > 1 && (
            <div className="flex items-center justify-between text-xs sm:text-sm mt-1.5 sm:mt-2">
              <span className="text-text-secondary">Average meal gap</span>
              <span className="font-semibold text-green-300">
                {formatMinutes(averageGapMinutes)}
              </span>
            </div>
          )}
        </motion.div>
